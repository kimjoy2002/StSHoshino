...
public class SavePointPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = DefaultMod.makeArisID("SavePointPower");
    ...
    public AbstractPower makeCopy() {
        return new SavePointPower(owner, amount);
    }
}
