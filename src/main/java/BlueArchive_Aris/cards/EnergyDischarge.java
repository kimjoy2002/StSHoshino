...
public class EnergyDischarge extends AbstractDynamicCard {
    public static final String ID = DefaultMod.makeArisID(EnergyDischarge.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeArisCardPath("EnergyDischarge.png");
