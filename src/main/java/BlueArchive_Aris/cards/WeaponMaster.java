...
public class WeaponMaster extends AbstractDynamicCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new WeaponMasterPower(AbstractDungeon.player, magicNumber)));
        this.addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new WeaponReturnPower(AbstractDungeon.player, magicNumber)));
    }
