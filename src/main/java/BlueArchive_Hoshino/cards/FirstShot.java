...
public class FirstShot extends CustomCard implements DrowsyCard, ShotCard {
    ...
    public static final String ID = DefaultMod.makeID(FirstShot.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("FirstShot.png");
