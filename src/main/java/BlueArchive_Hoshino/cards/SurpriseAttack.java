...
public class SurpriseAttack extends CustomCard implements ShotCard {
    ...
    public static final String ID = DefaultMod.makeID(SurpriseAttack.class.getSimpleName());
    ...
    public void triggerWhenDrawn() {
        ...
        this.setCostForTurn(this.cost + BulletSubscriber.reloadedThisTurn.get());
    }
    ...
    public AbstractCard makeCopy() {
        AbstractCard tmp = new SurpriseAttack();
