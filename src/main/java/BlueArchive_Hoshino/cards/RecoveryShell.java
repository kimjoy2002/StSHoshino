...
public class RecoveryShell extends CustomCard implements ShotCard {
    ...
    public static final String ID = DefaultMod.makeID(RecoveryShell.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("RecoveryShell.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        int draw_power = max(0, min(BulletSubscriber.getBullet() - 1, AMOUNT));
        ...
        if(draw_power > 0) {
            this.addToBot(new BulletModifyAction(-draw_power));
            AbstractDungeon.actionManager.addToBottom(new DrawCardAction(p, draw_power));
        }
    }
