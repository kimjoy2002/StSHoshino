...
public class FullBarrelFire extends CustomCard  implements ShotCard {
    ...
    public static final String ID = DefaultMod.makeID(FullBarrelFire.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("FullBarrelFire.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        int effect = BulletSubscriber.getBullet();
