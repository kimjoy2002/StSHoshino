...
import BlueArchive_Hoshino.actions.ShotDamageRandonEnemyAction;
...
public class BlindShot extends CustomCard implements ShotCard {
    ...
    public static final String IMG = makeCardPath("BlindShot.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for(int i = 0; i < this.magicNumber; ++i) {
            this.addToBot(new ShotDamageRandonEnemyAction(this, EnumPatch.HOSHINO_SHOTGUN));
        }
    }
