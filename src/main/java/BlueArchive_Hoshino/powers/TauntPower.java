...
public class TauntPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public TauntPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public void updateDescription() {
        ...
        description += source.name.replace(" ", " #y");
    ...
    public AbstractPower makeCopy() {
        return new TauntPower(owner, source, amount);
    }
}
