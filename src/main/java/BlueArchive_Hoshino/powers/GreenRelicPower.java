...
public class GreenRelicPower extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = DefaultMod.makeID("GreenRelicPower");
    ...
    public GreenRelicPower(AbstractCreature owner) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new GreenRelicPower(owner);
    }
}
