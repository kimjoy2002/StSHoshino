    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case 1:
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new ChesedStrPower(this, (AbstractDungeon.ascensionLevel >= 19) ?2:1), (AbstractDungeon.ascensionLevel >= 19) ?2:1));
                break;
            case 2:
