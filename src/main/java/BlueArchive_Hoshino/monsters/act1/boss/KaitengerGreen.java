...
public class KaitengerGreen extends KaitengerCommon {
    public static final String ID = DefaultMod.makeID(KaitengerGreen.class.getSimpleName());
    ...
    protected void getMove(int num) {
        {
            if(halfDead) {
                ...
                this.setMove(MOVES[0], (byte)2, Intent.ATTACK, ((DamageInfo)this.damage.get(1)).base, 3, true);
            } else {
    ...
    static {
        monsterStrings = CardCrawlGame.languagePack.getMonsterStrings("BlueArchive_Hoshino:Kaitenger_green");
