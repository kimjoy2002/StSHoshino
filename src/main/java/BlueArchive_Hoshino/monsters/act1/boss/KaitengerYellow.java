...
public class KaitengerYellow extends KaitengerCommon {
    public static final String ID = DefaultMod.makeID(KaitengerYellow.class.getSimpleName());
    private static final MonsterStrings monsterStrings;
    public static final String NAME;
    public static final String[] MOVES;
    public static final String[] DIALOG;
    private int dmg;
    private int dmg_sniper;
    private boolean first_attck = true;


    public KaitengerYellow() {
        this(0.0F, 0.0F);
    }

    public KaitengerYellow(float x, float y) {
        super(NAME, ID, 35, -5.0F, 0.0F, 150.0F, 250.0F, makeMonstersPath("Kaitenger_yellow.png"), x, y);
        ...
        this.damage.add(new DamageInfo(this, this.dmg_sniper, DamageInfo.DamageType.NORMAL));
    }

    public KaitengerCommon copyKaitenger(float x, float y) {

        return new KaitengerYellow(x,y);
    }
    ...
    protected void getMove(int num) {
        {
            if(halfDead) {
                ...
                this.setMove(MOVES[0], (byte)2, Intent.ATTACK, ((DamageInfo)this.damage.get(1)).base);
            } else {
    ...
    static {
        monsterStrings = CardCrawlGame.languagePack.getMonsterStrings("BlueArchive_Hoshino:Kaitenger_yellow");
